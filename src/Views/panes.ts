...
export class Pane {
  ...
  get virtualContext() {
    return this._virtualContext;
  }
  get context() {
    return this._virtualContext;
  }
  get element() {
    return this._canvas as JQuery<HTMLElement>;
  }
  ...
  _ensureCanvas() {
    ...
    this._canvas = $(
      "<canvas style='position: absolute' id = '" + this._canvasId + "'/>"
    );
  ...
  get width() {
    return this._canvas.width() as number;
  }
  get height() {
    return this._canvas.height() as number;
  }
